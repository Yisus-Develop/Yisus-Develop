...
[![GitHub](https://img.shields.io/badge/GitHub-Yisus--Develop-111?style=for-the-badge&logo=github)](https://github.com/Yisus-Develop)
...
- **Languages:** PHP 8.1+, TypeScript, JavaScript (ES6+), Python, Node.js.
- **Frameworks:** Laravel, React, Next.js, Astro.js.
- **WordPress/CMS:** Elementor, Gutenberg, WooCommerce, custom plugins/widgets.
- **Infra & DevOps:** Cloudflare (DNS/SSL/CDN), VPS, GitHub Actions (CI/CD), cPanel UAPI.
- **Data & SEO:** GA4, GTM, Search Console, Technical SEO / GEO.
- **AI/Automation:** MCP, Claude, GPT, Gemini CLI, OpenRouter, Ollama/LM Studio.
